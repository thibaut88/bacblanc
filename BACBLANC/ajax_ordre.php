...
$ordre=(isset($_GET['ordre']))? (string) $_GET['ordre']:'';
$categorie_id=(isset($_GET['categorie_id']))? $_GET['categorie_id']:'';
$categorie_id=str_replace('categorie-','',$categorie_id);
$categorie_id = (int) $categorie_id;

$conn=mysqli_connect('localhost','admin','admin','bacblanc');
$sql="SELECT * FROM videos WHERE videos_id_categorie = $categorie_id ORDER BY date_ajout $ordre";
